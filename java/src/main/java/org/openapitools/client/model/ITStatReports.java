...
public class ITStatReports {
  ...
  public boolean equals(Object o) {
    ...
    ITStatReports itStatReports = (ITStatReports) o;
    return Objects.equals(this.statTime, itStatReports.statTime) &&
        Objects.equals(this.agingTime, itStatReports.agingTime) &&
        Objects.equals(this.statStatus, itStatReports.statStatus) &&
        Objects.equals(this.statResult, itStatReports.statResult);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ITStatReports
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ITStatReports.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ITStatReports is not found in the empty JSON string", ITStatReports.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ITStatReports.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ITStatReports` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ITStatReports.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ITStatReports' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ITStatReports> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ITStatReports.class));

       return (TypeAdapter<T>) new TypeAdapter<ITStatReports>() {
           @Override
           public void write(JsonWriter out, ITStatReports value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ITStatReports read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ITStatReports given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ITStatReports
   * @throws IOException if the JSON string is invalid with respect to ITStatReports
   */
  public static ITStatReports fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ITStatReports.class);
  }

  /**
   * Convert an instance of ITStatReports to an JSON string
   *
   * @return JSON string
   */
