...
public class UpdateAnalysisTaskReq {
  ...
  public UpdateAnalysisTaskReq cleanSettings(@javax.annotation.Nullable CleanSettings cleanSettings) {
  ...
  public UpdateAnalysisTaskReq eventClass(@javax.annotation.Nullable String eventClass) {
  ...
  public UpdateAnalysisTaskReq eventGenSettings(@javax.annotation.Nullable EventGenSetting eventGenSettings) {
  ...
  public UpdateAnalysisTaskReq complexSettings(@javax.annotation.Nullable ComplexSetting complexSettings) {
  ...
  public UpdateAnalysisTaskReq expressionSettings(@javax.annotation.Nullable ExpressionSettings expressionSettings) {
  ...
  public UpdateAnalysisTaskReq taskName(@javax.annotation.Nullable String taskName) {
  ...
  public UpdateAnalysisTaskReq enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public UpdateAnalysisTaskReq period(@javax.annotation.Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public UpdateAnalysisTaskReq tagMatchers(@javax.annotation.Nullable List<TagMatcher> tagMatchers) {
  ...
  public UpdateAnalysisTaskReq condition(@javax.annotation.Nullable String condition) {
  ...
  public UpdateAnalysisTaskReq expressions(@javax.annotation.Nullable List<Expression> expressions) {
  ...
  public void setExpressions(@javax.annotation.Nullable List<Expression> expressions) {
    this.expressions = expressions;
  }
